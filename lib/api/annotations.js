define(['../utilities', '../headers'], function(utils, headers) {
    ...
    return function annotations() {
        ...
        return {
             ...
             * @returns {Promise}
             */
            patch: utils.requestWithDataFun('PATCH', '/annotations/{id}', ['id'], headers().contentType('annotation'), true),
             ...
             * @returns {Promise}
             */
            create: utils.requestWithDataFun('POST', '/annotations/', [], headers().contentType('annotation'), true),
