define(function() {
    ...
    */
    ...
    function typeHeader(headerType) {
        return function(contentType) {
            return this.set(headerType, contentTypes[contentType] || contentType || '*/*');
        };
    }

    Headers.prototype.accept = typeHeader('Accept');
    Headers.prototype.contentType = typeHeader('Content-Type');
